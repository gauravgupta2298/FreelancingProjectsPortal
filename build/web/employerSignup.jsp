...
<html>
    ...
    <center>
        ...
        <form action="EmployerSignupChecker" method="post">
            <table>
                <tr>
                    <td><B>Username:</B></td>
                ...
                <tr>
                    ...
                    <td><input type="text" name="company" placeholder="Enter Company Name Here"></td>
                </tr>
                <tr>
                    <td><B>Email:</B></td>
        ...
        <br><br><h3>Already a Registered Employer?... <a href="home.jsp">Click here to Login</a></h3>
    </center>
    </body>
</html>
